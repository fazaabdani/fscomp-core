      ...
      <div className="qcLayout">
        <form className="panel qcForm qcCompactForm" action={createDailyQcAction}>
          ...
          <div className="infoBox compactInfo">
            Status otomatis: layar yang lolos hanya <strong>Normal</strong> dan <strong>White spot</strong>. Selain itu otomatis tidak lolos dan masuk candidate retur.
            Urusan software/kelengkapan seperti OS, driver, jam, aplikasi, partisi, Office, karet bawah, trackpoint, keyboard backlight, dan cat ringan dibuat reminder penyelesaian, bukan langsung menggagalkan hardware.
          </div>
          <label>
            Catatan harian
